...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || "lib.wast";
  var wasmBinaryFile = Module['wasmBinaryFile'] || "lib.wasm";
  var asmjsCodeFile = Module['asmjsCodeFile'] || "lib.asm.js";
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "lib.js.mem" : null;




var STATIC_BUMP = 18528;
...
var real__rust_function = asm["_rust_function"]; asm["_rust_function"] = function() {
assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
return real__rust_function.apply(null, arguments);
};
...
var _rust_function = Module["_rust_function"] = asm["_rust_function"];
